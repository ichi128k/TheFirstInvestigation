...
namespace TFI.Vehicles
{
    public class TFIAeroplaneAudio : MonoBehaviour
    {
		...
		[SerializeField] private float maxAlarmSoundPitch;
		...
		private AudioSource alarmSoundSource;    // Reference to the AudioSource for the wind.
		private AudioSource hitSoundSource;    // Reference to the AudioSource for the wind.

        private FrozenAeroplaneController m_Plane;      // Reference to the aeroplane controller.
        private Rigidbody m_Rigidbody;

		[SerializeField] private Health planeHealth;

        private void Awake()
        {
            // Set up the reference to the aeroplane controller.
			m_Plane = GetComponent<FrozenAeroplaneController>();
			...
			alarmSoundSource = gameObject.AddComponent<AudioSource>();
			alarmSoundSource.playOnAwake = false;
			...
			alarmSoundSource.clip = alarmSound;
		...
		public void OnDamage()
		{
			...
			{
				alarmSoundSource.pitch = planeHealth.health > 20 ? 1 : 1.5f;
